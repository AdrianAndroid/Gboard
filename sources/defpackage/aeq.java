...
final class aeq extends InputStream implements DataInput, InputStreamRetargetInterface {
    protected final DataInputStream a;
    protected int b;
    public ByteOrder c;
    private byte[] d;

    public aeq(InputStream inputStream) {
    ...
    public aeq(InputStream inputStream, ByteOrder byteOrder) {
    ...
    public aeq(InputStream inputStream, byte[] bArr) {
        this(inputStream);
    ...
    public aeq(byte[] bArr, byte[] bArr2) {
        this(bArr);
        this.a.mark(Integer.MAX_VALUE);
    }
}
