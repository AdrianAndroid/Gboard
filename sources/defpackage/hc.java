...
public final class hc extends gd implements Menu {
    private final wm c;

    public hc(Context context, wm wmVar) {
        super(context);
        this.c = wmVar;
    }
    ...
    public final void removeItem(int i) {
        if (this.b != null) {
            ...
            while (true) {
                ...
                if (i2 >= qvVar.d) {
                    break;
                } else if (((wn) qvVar.c(i2)).getItemId() == i) {
                    this.b.d(i2);
                    break;
                } else {
                    i2++;
    ...
    public final MenuItem add(int i, int i2, int i3, CharSequence charSequence) {
        return a(((gm) this.c).c(i, i2, i3, charSequence));
    }
