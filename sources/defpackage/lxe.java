...
public class lxe extends lxc {
    ...
    static {
        ...
        L10:
            ...
            return
        */
        throw new UnsupportedOperationException("Method not decompiled: defpackage.lxe.<clinit>():void");
    }
    ...
    public static int b(String str, int i) {
        while (i < str.length()) {
            ...
            if (str.charAt(i) != '%') {
                ...
                throw lxd.c("trailing unquoted '%' character", str, i2 - 1);
            }
        }
        return -1;
    }
