...
public class kuz extends kx {
    ...
    public kuz(Context context, AttributeSet attributeSet) {
        this(context, attributeSet, 0);
    }

    public kuz(Context context, AttributeSet attributeSet, int i) {
        ...
        this.a = true;
        this.b = false;
        TypedArray a = kve.a(context, attributeSet, kvb.a, i, 0, new int[0]);
