...
final class vn {
    ...
    static {
        ...
        float f15 = fArr7[1];
        a = new vn(c2, (f14 + f14 + ((f15 * 400.0f) / (f15 + 27.13f)) + (((400.0f * pow2) / (pow2 + 27.13f)) * 0.05f)) * pow, pow, pow, fArr6, cbrt, (float) Math.pow(cbrt, 0.25d), ((float) sqrt) + 1.48f);
    }

    private vn(float f, float f2, float f3, float f4, float[] fArr, float f5, float f6, float f7) {
        this.f = f;
        this.b = f2;
        this.c = f3;
        this.d = f4;
