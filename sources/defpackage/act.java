...
public final class act implements ActionMode.Callback {
    ...
    public act(ActionMode.Callback callback, TextView textView) {
        this.a = callback;
        this.b = textView;
    }
    ...
    public final boolean onPrepareActionMode(ActionMode actionMode, Menu menu) {
        ...
        try {
            Method declaredMethod = (!this.e || !this.c.isInstance(menu)) ? menu.getClass().getDeclaredMethod("removeItemAt", Integer.TYPE) : this.d;
            int size = menu.size();
            while (true) {
                size--;
                if (size < 0) {
