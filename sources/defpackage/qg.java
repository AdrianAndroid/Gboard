...
public final class qg extends Drawable {
    public float a;
    public float b;
    ...
    public qg(ColorStateList colorStateList, float f) {
        this.a = f;
        a(colorStateList);
    }
    ...
    public final void b(Rect rect) {
        ...
        this.h.set(rect);
        if (this.c) {
            float b = qh.b(this.b, this.a, this.d);
            this.h.inset((int) Math.ceil(qh.a(this.b, this.a, this.d)), (int) Math.ceil(b));
            this.g.set(this.h);
        }
    }
