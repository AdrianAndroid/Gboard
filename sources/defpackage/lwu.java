...
public enum lwu {
    ...
    static {
        ...
        for (lwu lwuVar : values()) {
            if (hashMap.put(Character.valueOf(lwuVar.G), lwuVar) != null) {
                new StringBuilder("duplicate format character: ").append(lwuVar);
                throw new IllegalStateException("duplicate format character: ".concat(String.valueOf(lwuVar)));
            }
        }
