...
class ij {
    ...
    public void b(AttributeSet attributeSet, int i) {
        gkn w = gkn.w(this.c.getContext(), attributeSet, b, i, 0);
        Drawable o = w.o(0);
        if (o != null) {
            ProgressBar progressBar = this.c;
            if (o instanceof AnimationDrawable) {
                AnimationDrawable animationDrawable = (AnimationDrawable) o;
                ...
                o = animationDrawable2;
            }
            progressBar.setIndeterminateDrawable(o);
        }
        Drawable o2 = w.o(1);
        if (o2 != null) {
            this.c.setProgressDrawable(a(o2, false));
        }
        w.r();
    }
}
