...
public class LatinPageableCandidatesHolderView extends alc implements dew, jdb {
    ...
    public LatinPageableCandidatesHolderView(Context context, AttributeSet attributeSet) {
        ...
        if (d < 0) {
            ((ltd) q.a(hip.a).k("com/google/android/apps/inputmethod/latin/keyboard/widget/LatinPageableCandidatesHolderView", "<init>", 161, "LatinPageableCandidatesHolderView.java")).u("rowCount [%d] < 0", d);
            i = 4;
        } else {
            i = d;
        }
        ...
        if (d2 < 0) {
            ((ltd) q.a(hip.a).k("com/google/android/apps/inputmethod/latin/keyboard/widget/LatinPageableCandidatesHolderView", "<init>", 168, "LatinPageableCandidatesHolderView.java")).u("maxCandidatesPerRow [%d] < 0", d2);
            i2 = 6;
        } else {
            i2 = d2;
        }
