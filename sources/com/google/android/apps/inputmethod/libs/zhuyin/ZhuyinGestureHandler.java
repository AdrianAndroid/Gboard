...
public class ZhuyinGestureHandler extends AbstractHmmGestureMotionEventHandler {
    ...
    public ZhuyinGestureHandler(Context context, igy igyVar) {
        super(context, igyVar);
        fdo fdoVar = new fdo(this, 3);
        this.j = fdoVar;
        ino M = ino.M(context);
        M.X(fdoVar, R.string.f161560_resource_name_obfuscated_res_0x7f1406bd);
        t(M);
    }
    ...
    protected final boolean p(SoftKeyView softKeyView) {
        iay e = softKeyView.e();
        return (e == null || fgl.a(e.c) == null) ? false : true;
    }
