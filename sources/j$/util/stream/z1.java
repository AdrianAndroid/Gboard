...
public final class x1 extends C1 implements j$.util.n {
    /* JADX INFO: Access modifiers changed from: package-private */
    public x1(j$.util.n nVar, long j, long j2) {
        super(nVar, j, j2);
    }

    x1(j$.util.n nVar, long j, long j2, long j3, long j4) {
        super(nVar, j, j2, j3, j4);
    }

    @Override // j$.util.stream.E1
    protected final j$.util.r c(j$.util.r rVar, long j, long j2, long j3, long j4) {
        return new x1((j$.util.n) rVar, j, j2, j3, j4);
    }
